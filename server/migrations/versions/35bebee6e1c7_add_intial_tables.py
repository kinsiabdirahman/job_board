...
Revision ID: 35bebee6e1c7
Revises: 
Create Date: 2024-04-18 15:12:58.798667
...
def upgrade():
    ...
    sa.Column('academic_history', sa.String(), nullable=True),
    ...
    sa.Column('job_salary', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
